...
def test_integration_entry_contract_keeps_one_local_only_baseline() -> None:
    ...
    assert contract["screenContractVersion"] == "ORDERAI-INTEGRATION-W2-10"
    ...
    assert baseline["consumerConversation"] == {
        "reuseMode": "INTEGRATE_VIA_ADAPTER",
        "screenId": "orderai.consumer_conversation",
        "contractVersion": "ORDERAI-CONSUMER-CONVERSATION-W2-01",
        "availability": "available_synthetic",
    }
    assert baseline["reviewQueue"] == {
        "reuseMode": "INTEGRATE_VIA_ADAPTER",
        "screenId": "orderai.review_queue",
        "contractVersion": "ORDERAI-REVIEW-QUEUE-W2-01",
        "availability": "available_synthetic",
    }
    assert baseline["confirmationHandoff"] == {
        "reuseMode": "NEEDS_OWNER_DECISION",
        "interfaceId": "orderai.confirmation_handoff",
        "contractVersion": "ORDERAI-CONFIRMATION-HANDOFF-W2-01",
        "availability": "BLOCKED",
    }
    assert {"smart_agriculture_expo", "expo_p0_handoff", "consumer_conversation", "review_queue", "confirmation_handoff"}.issubset(contract["requiredViews"])
...
def test_integration_fixture_covers_five_locales_and_fail_closed_paths() -> None:
    ...
    assert fixture["fixtureVersion"] == "ORDERAI-INTEGRATION-FIXTURE-W2-10"
